...
describe('MultisigSupplyCalculator', () => {
  ...
  describe('single address', () => {
    it('should return balance for a single address', async () => {
      ...
      calculator = new MultisigSupplyCalculator(mockPublicClient, addresses)

      mockPublicClient.readContract.mockResolvedValueOnce(BigInt(1000))
  ...
  describe('edge cases', () => {
    it('should return zero for empty address array', async () => {
      calculator = new MultisigSupplyCalculator(mockPublicClient, [])
