...
```javascript
const provider = new providers.JsonRpcProvider("https://baklava-forno.celo-testnet.org");
...
const expectedAmountOut = await mento.getAmountOut(tokenIn, tokenOut, utils.parseUnits(one.toString(), 18));
